...
* Currently if you symlink everything, your GitHub user name will be pointed at my account and gpg key.  It is recommended that if you want to use my .gitconfig file, to make a fork of this repo and update that account info to your own in your repo.  Otherwise, just comment out the part that symlinks .gitconfig.  For that reason, I've temporarily commented out the symlinking of .gitconfig.  
