...
* NOTE: if you run ./link-dotfiles.sh then you will have to manually type `exit` to get out of the oh-my-zsh installation to proceed with the rest of the process.  This is a stupid bug.
